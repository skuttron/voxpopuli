...
def theme_css(t):
    ...
    return "".join([
        ...
        ".title-row-wrap{padding:10px 8px 0}.logo-wrap{padding:20px 0 10px}",
        ...
        ".tile-grid{display:inline-grid!important;grid-template-columns:repeat(4,1fr)!important;gap:8px!important;padding:0 8px!important;box-sizing:border-box;margin:8px 0}",
        ".tile{padding:16px 4px;border-radius:12px;width:100%;flex:none;min-width:0;max-width:none;font-size:8px;box-shadow:0 0 16px var(--p30)}.tile i{font-size:22px;margin-bottom:8px}.tile div{font-size:9px;letter-spacing:0}",
